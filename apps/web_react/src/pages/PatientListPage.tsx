        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pl-12 border-2 border-[var(--border)] rounded-lg bg-[var(--bg-primary)] text-[var(--text-primary)] focus:border-[var(--button-primary)] transition-colors"
            />
          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                ...
                <p className="text-sm text-[var(--text-secondary)]">{patient.lastUpdate}</p>
              </div>
            ...
            <div className="space-y-2">
              <p className={`font-medium ${patient.status === 'urgent' ? 'text-[var(--status-error)]' : 'text-[var(--text-primary)]'}`}>
                {patient.condition}
              </p>
              <p className="text-sm text-[var(--text-secondary)]">{patient.nextCheckIn}</p>
