...
export const CaregiverDashboard: React.FC = () => {
  ...
  const upcomingCheckIns = [
    { id: 1, patient: 'Sarah Johnson', time: '10:00 AM', status: 'urgent' as const },
    { id: 2, patient: 'Robert Chen', time: '2:00 PM', status: 'normal' as const },
    { id: 3, patient: 'James Miller', time: '4:30 PM', status: 'normal' as const },
    { id: 4, patient: 'Emily Davis', time: '5:15 PM', status: 'normal' as const },
    { id: 5, patient: 'Michael Brown', time: '6:00 PM', status: 'urgent' as const },
    { id: 6, patient: 'Patricia Wilson', time: '7:30 PM', status: 'normal' as const },
    { id: 7, patient: 'David Martinez', time: '8:00 PM', status: 'normal' as const }
  ];
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--text-secondary)]">Timezone: EDT</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="space-y-6" style={{
        ...
        <div className="space-y-3">
          ...
          <Alert type="error">
            ...
            <p className="mt-1">3 patients have missed their scheduled check-ins today.</p>
          </Alert>

          <Alert type="warning">
            <strong>Reminder:</strong>
            <p className="mt-1">Sarah Johnson reported severe symptoms. Follow up required.</p>
          </Alert>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-2 text-[var(--button-primary)]">
              <Users size={28} />
              <div className="text-sm text-[var(--text-secondary)]"># of Missed Check-Ins</div>
            </div>
          ...
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-2 text-[var(--status-success)]">
              <Activity size={28} />
              <div className="text-sm text-[var(--text-secondary)]">Active Patients</div>
            </div>
            <div className="text-3xl font-bold text-[var(--text-primary)]">32</div>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <Clock size={24} className="mx-auto mb-2 text-[var(--button-primary)]" />
          ...
          <button
            ...
            className="p-4 bg-[var(--bg-surface)] border-2 border-[var(--border)] rounded-lg hover:border-[var(--button-primary)] transition-colors"
          >
            <Users size={24} className="mx-auto mb-2 text-[var(--button-primary)]" />
